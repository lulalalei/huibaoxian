...
public class MyUnderPayInMyOrderAdapter extends RecyclerView.Adapter<MyUnderPayInMyOrderAdapter.MyViewHolder>{
    ...
    public MyUnderPayInMyOrderAdapter(Context mContext, List<GetTradesBean.TradeListBean> list) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=inflater.inflate(R.layout.underpay_myorder_item,parent,false);
