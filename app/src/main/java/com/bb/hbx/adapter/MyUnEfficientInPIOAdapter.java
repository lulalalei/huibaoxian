...
public class MyUnEfficientInPIOAdapter extends BaseAdapter{

    ArrayList<MyPIOederBean> list;
    Context mContext;
    LayoutInflater inflater;

    public MyUnEfficientInPIOAdapter(ArrayList<MyPIOederBean> list, Context mContext) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Log.e("============","======MyUnEfficientInPIOAdapter=====");
        MyViewHolder holder;
        if (convertView==null)
        {
