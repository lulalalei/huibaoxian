...
public class MyHadStopInCarInsuAdapter extends RecyclerView.Adapter<MyHadStopInCarInsuAdapter.MyViewHolder>{
    ...
    public MyHadStopInCarInsuAdapter(Context mContext, List<GetPolicies.PolicyListBean> list) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=inflater.inflate(R.layout.hadstop_carinsu_item,parent,false);
