...
public class MyPresentRecordInMyCustomAdapter extends RecyclerView.Adapter<MyPresentRecordInMyCustomAdapter.MyViewHolder>{
    ...
    public MyPresentRecordInMyCustomAdapter(ArrayList<String> list, Context mContext) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.presentrecord_mycustom_item, parent, false);
