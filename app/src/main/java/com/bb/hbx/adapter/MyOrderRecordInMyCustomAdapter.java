...
public class MyOrderRecordInMyCustomAdapter extends RecyclerView.Adapter<MyOrderRecordInMyCustomAdapter.MyViewHolder>{
    ...
    public MyOrderRecordInMyCustomAdapter(ArrayList<String> list, Context mContext) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.orderrecord_mycustom_item, parent, false);
