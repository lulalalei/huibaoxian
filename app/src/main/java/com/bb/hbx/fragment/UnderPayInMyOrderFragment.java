...
public class UnderPayInMyOrderFragment extends BaseFragment{
    ...
    MyUnderPayInMyOrderAdapter adapter;

    int pageIndex=1;
    private static UnderPayInMyOrderFragment fragment;
    public static UnderPayInMyOrderFragment getInstance()
    {
        if (fragment==null)
        {
            fragment=new UnderPayInMyOrderFragment();
        }
        return fragment;
    }
    ...
    public int getLayoutId() {
        return R.layout.fragment_underpay_inmyorder_layout;
    }
    ...
    protected void initdate(Bundle savedInstanceState) {
        ...
        adapter = new MyUnderPayInMyOrderAdapter(mContext, list);
    ...
    private void showTradesList(final int pageIndex) {
        ...
        Call call=service.getTrades(MyApplication.user.getUserId(),"10",pageIndex+"","10");
