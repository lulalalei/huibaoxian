...
import com.bb.hbx.R;
import com.bb.hbx.adapter.MyOrderAdapter;
...
public class MyOrderActivity extends BaseActivity implements View.OnClickListener{
    ...
    ArrayList<MyOrderContentFragment> fragmentList=new ArrayList<>();

    String []title=new String[]{"全部","待支付","已完成"};
    ...
    public void initdata() {
        Can.myOrderFragmentList=Can.getFragmentListInMyOrder();
        ...
        adapter = new MyOrderAdapter(getSupportFragmentManager(), fragmentList, title);
