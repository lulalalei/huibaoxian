package com.bb.hbx.widget.banner;
...
import com.bb.hbx.R;
import com.bb.hbx.widget.banner.transformer.BGAPageTransformer;
import com.bb.hbx.widget.banner.transformer.TransitionEffect;
...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
        ...
        if (mEnterView != null || mSkipView != null) {
            mViewPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
                ...
                public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                    ...
                    //Log.i("fancl","arg0="+position+"-----arg1="+positionOffset+"----arg2="+positionOffsetPixels);
    ...
    @Override
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        //Log.e("fancl","arg0="+position+"-----arg1="+positionOffset+"----arg2="+positionOffsetPixels);
